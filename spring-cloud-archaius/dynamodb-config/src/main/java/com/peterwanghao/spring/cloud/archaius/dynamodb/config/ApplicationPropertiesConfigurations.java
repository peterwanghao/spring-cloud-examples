...
import com.peterwanghao.spring.cloud.archaius.dynamodb.entity.ArchaiusProperties;
import com.peterwanghao.spring.cloud.archaius.dynamodb.entity.ArchaiusPropertiesRepository;
/**   
 * @ClassName:  ApplicationPropertiesConfigurations
 * @Description:TODO(这里用一句话描述这个类的作用)
 * @author: wanghao
 * @date:   2018年11月20日 下午4:58:03
 * @version V1.0
 * 
 */
@Configuration
