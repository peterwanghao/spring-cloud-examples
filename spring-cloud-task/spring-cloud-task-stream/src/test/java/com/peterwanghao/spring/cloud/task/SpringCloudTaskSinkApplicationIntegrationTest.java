...
/**   
 * @ClassName:  SpringCloudTaskSinkApplicationIntegrationTest
 * @Description:TODO(这里用一句话描述这个类的作用)
 * @author: wanghao
 * @date:   2018年10月12日 下午2:56:35
 * @version V1.0
 * 
 */
...
public class SpringCloudTaskSinkApplicationIntegrationTest {
	...
	public void testTaskLaunch() throws IOException {
		...
		TaskLaunchRequest request = new TaskLaunchRequest(
				"maven://org.springframework.cloud.task.app:" + "timestamp-task:jar:1.0.1.RELEASE", null, prop, null,
				null);
